...
class TestPyLinexpr1(unittest.TestCase):
    ...
    def test_init(self):
        ...
        self.assertEqual(str(PyLinexpr1(e, 0)), '0.0·x + 0.0·y + 0.0·z + 0.0')

    def test_is_integer(self):
        e = PyEnvironment([PyVar('x'), PyVar('y')], [PyVar('z')])
        x0 = PyLinexpr1(e)
        x0.set_coeff(PyVar('x'), PyDoubleScalarCoeff(3))
    ...
    def test_is_linear(self):
        ...
        x1 = PyLinexpr1(e)
        x1.set_coeff(PyVar('x'), PyDoubleIntervalCoeff(3, 3))
        x1.set_cst(PyDoubleIntervalCoeff(-9, 9))
        self.assertFalse(x1.is_linear())
        x2 = PyLinexpr1(e)
        x2.set_coeff(PyVar('x'), PyDoubleScalarCoeff(3))
